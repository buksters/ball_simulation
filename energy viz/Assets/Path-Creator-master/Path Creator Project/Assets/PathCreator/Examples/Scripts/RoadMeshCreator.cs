    ...
    public class RoadMeshCreator : PathSceneTool {
        ...
        void CreateRoadMesh () {
            ...
            for (int i = 0; i < path.NumPoints; i++) {
                ...
                // Top of road normals
                normals[vertIndex + 0] = localDiagonalRight;
                normals[vertIndex + 1] = localDiagonalLeft;
                // Bottom of road normals
                normals[vertIndex + 2] = -localDiagonalRight;
                normals[vertIndex + 3] = -localDiagonalLeft;
